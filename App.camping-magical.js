...
// Données magiques pour camping forêt nuit
        ...
        <Animated.View
          ...
          style={[
            styles.star,
            {
              ...
              height: star.size,
              opacity: animated ? 
                Animated.add(0.5, Animated.multiply(
                  0.5,
                  Animated.sin(new Animated.Value(0).setValue(Date.now() / star.twinkleSpeed))
                )) : star.opacity
            }
          ]}
        />
...
function LoginScreen({ onLoginSuccess }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={['#0a0f1f', '#1a1f3f', '#2d2f5f', '#1a1f3f', '#0a0f1f']}
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.magicalBadges}>
              ...
              <View style={styles.badge}>
                <Text style={styles.badgeText}>🦉 Esprits Forestiers</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.form}>
            ...
            >
              ...
              >
                {isLoading ? (
                  <Text style={styles.buttonText}>🌙 OUVERTURE DU PORTAIL...</Text>
                ) : (
                  <Text style={styles.buttonText}>✨ ENTRER DANS LA FORÊT</Text>
                )}
              </LinearGradient>
            </TouchableOpacity>
            ...
            <View style={styles.magicalInfo}>
              ...
              <Text style={styles.magicalText}>🦉 Esprits gardiens présents</Text>
            </View>
          </View>
        </Animated.View>
      </ScrollView>
...
function HomeScreen({ user, onLogout }) {
  ...
  useEffect(() => {
    ...
    // Animation de pulse pour les éléments magiques
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Header Magique */}
        <Animated.View style={[styles.dashboardHeader, { transform: [{ scale: pulseAnim }] }]}>
          <LinearGradient
                  ...
                  <View style={styles.avatarContainer}>
                    ...
                    <Animated.View 
                      style={[
                        styles.magicAura,
                        { 
                          borderColor: getMagicColor(participant.magic_level),
                          opacity: participant.sos ? 0.8 : 0.3,
                          transform: [{ scale: participant.sos ? pulseAnim : 1 }]
                        }
                      ]} 
                    />
                  </View>
